export const homeHeroSlides = [
  {
    ...
    background: {
      imageUrl: '/src/assets/home/Carouse4.jpg',
      overlay: true,
      overlayOpacity: 0.1,
    },
    layers: [
      ...
      },
      {
        id: 'a-desc',
        type: 'desc',
        content: 'Build faster with payment devices and software that scale across unattended, mobile, and countertop scenarios.',
  ...
  },
  {
    ...
    background: {
      imageUrl: '/src/assets/home/Carouse3.jpg',
      overlay: true,
      overlayOpacity: 0.3,
    },
    layers: [
      ...
      },
      {
        id: 'b-desc',
        type: 'desc',
        content: 'From OEM integrations to enterprise deployment, deliver consistent payment experiences with confidence.',
  ...
  },
  {
    ...
    background: {
      imageUrl: '/src/assets/home/Carouse1.jpg',
      overlay: true,
      overlayOpacity: 0.5,
    },
    layers: [
      {
        ...
        position: { anchor: 'center', top: '36%', left: '39%', translateX: '-50%', translateY: '-50%' },
      ...
      },
      {
        ...
        position: { anchor: 'center', top: '36%', left: '61%', translateX: '-40%', translateY: '-50%' },
      ...
      },
      {
        id: 'c-image',
        type: 'fgImage',
        imageUrl: '/src/assets/home/CarouseInside.jpg',
        position: { anchor: 'center', top: '64%', left: '39%', translateX: '-50%', translateY: '-50%' },
      ...
      },
      {
        ...
        position: { anchor: 'center', top: '64%', left: '61%', translateX: '-50%', translateY: '-50%' },
